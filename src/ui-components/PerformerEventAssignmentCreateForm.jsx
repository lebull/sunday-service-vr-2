...
export default function PerformerEventAssignmentCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setTimespan(initialValues.timespan);
    setErrors({});
  };
  const validations = {
    timespan: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PerformerEventAssignment(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PerformerEventAssignmentCreateForm")}
      {...rest}
    >
      <SelectField
        label="Timespan"
